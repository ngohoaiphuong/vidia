  ...
  module V1
    module Addresses
      class WardsController < Api::CoreBaseController
        ...
        api :GET, 'v1/addresses/cities/:city_id/districts/:district_id/wards', 'Get wards list'
        ...
        api :GET, 'v1/addresses/cities/:city_id/districts/:district_id/wards/:id', 'Get cities list'
        meta author: { name: 'Vidia' }
        param :city_id, String, desc: "City ID"
        param :district_id, String, desc: "District ID"
